        ...
        <section className="container custom_bg_1 3xl h-4/5 flex justify-center items-center " id='Experience'>
            <section className='w-4/5 h-4/5 flex flex-col'>
                ...
                <div className='flex flex-col gap-y-3 w-full my-5 pt-5 pb-5 3xl:mt-8 2xl:mt-10 3xl:px-16 2xl:px-16 xs:px-0'>
                    <div>
                        <div className='grid gap-x-2 item-center 3xl:grid-cols-3 2xl:grid-cols-3 xs:grid-cols-1 3xl:gap-y-0 2xl:gap-y-0 xs:gap-y-2'>
...
const PillarTop = () => {
    return (
        <div className='mx-auto rounded-t-full bg-sky-500 h-full 3xl:w-2 2xl:w-2 xs:w-1'>
...
const Pillar = () => {
    return (
        <div className='mx-auto bg-sky-500 h-full 3xl:w-2 2xl:w-2 xs:w-1'>
...
const PillarBottom = () => {
    return (
        <div className='mx-auto rounded-b-full bg-sky-500 h-full 3xl:w-2 2xl:w-2 xs:w-1'>
...
const EventCard = ({title, date, companyname, location}) => {
    return (
        <div className='flex flex-col rounded-xl p-4 items-start w-full bg-red-500'>
            <h1 className='custom_font_color_1 tracking-wider text-start pt-2 pb-2 capitalize font-semibold 3xl:text-2xl 2xl:text-xl xs:text-base'>{title}</h1>
            <h1 className='text-white 3xl:text-xl 2xl:text-lg xs:text-sm'>{date}</h1>
            <h1 className='text-white 3xl:text-xl 2xl:text-lg xs:text-sm'>{companyname}</h1>
            <h1 className='text-white 3xl:text-xl 2xl:text-lg xs:text-sm'>{location}</h1>
        </div>
    )
}
