        ...
        <section className="container custom_bg_2 3xl flex justify-center items-center 3xl:h-4/5 2xl:h-4/5 xl:h-4/5 md:h-full xs:h-full  xxs:h-full" id='AboutMe'>
            <section className='w-4/5 flex 3xl:h-4/5 2xl:h-4/5 xl:h-4/5 md:h-4/5 xs:h-4/5 xxs:h-4/5'>
                <div className=' w-full h-full '>
                    ...
                    <div className='flex w-full h-full 3xl:flex-row 2xl:flex-row xl:flex-row md:flex-col-reverse xs:flex-col-reverse xxs:flex-col-reverse'>
                        <div className='h-2/3 3xl:w-2/3 2xl:w-2/3 xl:w-2/3 md:w-full xs:w-full xxs:w-full '>
                            <p className='text-white text-justify leading-8 3xl:indent-14 2xl:indent-14 xl:indent-10 md:indent-10 xs:indent-8  xxs:indent-6 3xl:text-xl 2xl:text-lg xl:text-lg md:text-lg xs:text-sm  xxs:text-sm 3xl:mt-16 2xl:mt-16 xl:mt-16 md:mt-14 xs:mt-6  xxs:mt-6'>
