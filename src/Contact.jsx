...
function Contact () {
    ...
    return (
        <section className="container custom_bg_2 3xl flex flex-col items-center " id='Contact'>
            <section className='w-4/5 h-4/6 flex flex-col  p-5 pb-0'>
                <div className='w-full h-full px-16 '>
                    <h1 className='custom_font_color_1 tracking-wider text-start px-5 p-5 text-3xl uppercase font-semibold' >Contact</h1>
                    <div className='flex h-2/3 mt-10'>
                        <div className='w-4/6  pt-10 pb-5 px-5 flex flex-col items-start uppercase'>
                            <h3 className='text-white text-xl  mt-2 leading-8'>
                                Jilbert S. Vasquez
                            </h3>
                            <h3 className='text-white text-xl  mt-2 leading-8'>
                                bs cpe
                        ...
                        <div className='w-2/6 pt-5 pb-5 flex justify-center items-center '>
